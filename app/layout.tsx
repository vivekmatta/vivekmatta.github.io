...
export const metadata: Metadata = {
	...
	authors: [{ name: 'Vivek Matta' }],
	creator: 'Vivek Matta',
	openGraph: {
		title: 'Vivek Matta - Developer Portfolio',
		description: 'Passionate developer creating simple and effective solutions. Explore my projects and development approach.',
		url: 'https://vivekmatta.com',
		siteName: 'Vivek Matta - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Vivek Matta - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
